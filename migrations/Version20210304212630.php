 ...
 */
final class Version20210304212630 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE restaurant (id_resto INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, tel BIGINT NOT NULL, email VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, specialite VARCHAR(255) DEFAULT NULL, INDEX IDX_EB95123FF675F31B (author_id), PRIMARY KEY(id_resto)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categorie_menu DROP FOREIGN KEY FK_A2CBDC4BCF5E72D');
        $this->addSql('ALTER TABLE livraison DROP FOREIGN KEY FK_A60C9F1FAFAF5C55');
        $this->addSql('ALTER TABLE categorie_menu DROP FOREIGN KEY FK_A2CBDC4CCD7E912');
